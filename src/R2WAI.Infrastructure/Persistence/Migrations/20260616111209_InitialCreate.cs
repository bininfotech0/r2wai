        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ApproverRoles = table.Column<string>(type: "jsonb", nullable: true),
                    MinApprovers = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    EscalationMinutes = table.Column<int>(type: "integer", nullable: true),
                    EscalationRoles = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalPolicies_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModelConfigurations_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToolDefinitions_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VectorCollectionName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Metadata = table.Column<string>(type: "jsonb", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentBlocks = table.Column<string>(type: "jsonb", nullable: true),
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistantDefinitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssistantDefinitions_KnowledgeBases_KnowledgeBaseId",
                        column: x => x.KnowledgeBaseId,
                        principalTable: "KnowledgeBases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AssistantDefinitions_ModelConfigurations_ModelConfiguration~",
                        column: x => x.ModelConfigurationId,
                        principalTable: "ModelConfigurations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AssistantDefinitions_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedQuestions = table.Column<string>(type: "jsonb", nullable: true),
                    ModelConfigurationId = table.Column<Guid>(type: "uuid", nullable: true),
                    KnowledgeBaseId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chatbots_KnowledgeBases_KnowledgeBaseId",
                        column: x => x.KnowledgeBaseId,
                        principalTable: "KnowledgeBases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Chatbots_ModelConfigurations_ModelConfigurationId",
                        column: x => x.ModelConfigurationId,
                        principalTable: "ModelConfigurations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VectorIds = table.Column<string>(type: "jsonb", nullable: true),
                    Metadata = table.Column<string>(type: "jsonb", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KnowledgeBaseSources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KnowledgeBaseSources_KnowledgeBases_KnowledgeBaseId",
                        column: x => x.KnowledgeBaseId,
                        principalTable: "KnowledgeBases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalPolicies_TenantId_Name",
                table: "ApprovalPolicies",
                columns: new[] { "TenantId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalPolicies_TenantId_WorkflowType",
                table: "ApprovalPolicies",
                columns: new[] { "TenantId", "WorkflowType" });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_DueAt",
                table: "ApprovalRequests",
                column: "DueAt",
                filter: "\"DueAt\" IS NOT NULL AND \"Status\" = 'Pending'");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_TenantId_ApproverId",
                table: "ApprovalRequests",
                columns: new[] { "TenantId", "ApproverId" });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_TenantId_Status",
                table: "ApprovalRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistantDefinitions_KnowledgeBaseId",
                table: "AssistantDefinitions",
                column: "KnowledgeBaseId");

            migrationBuilder.CreateIndex(
                name: "IX_AssistantDefinitions_ModelConfigurationId",
                table: "AssistantDefinitions",
                column: "ModelConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_AssistantDefinitions_TenantId_Name",
                table: "AssistantDefinitions",
                columns: new[] { "TenantId", "Name" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chatbots_KnowledgeBaseId",
                table: "Chatbots",
                column: "KnowledgeBaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Chatbots_ModelConfigurationId",
                table: "Chatbots",
                column: "ModelConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_Chatbots_TenantId_Name",
                table: "Chatbots",
                columns: new[] { "TenantId", "Name" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_TenantId_Module",
                table: "Conversations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeBaseSources_KnowledgeBaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModelConfigurations_TenantId_IsDefault",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowInstances_WorkflowId_Status",
                table: "WorkflowInstances",
